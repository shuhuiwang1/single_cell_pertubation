from scripts.simple_model import Simple_residual
...
def train_model(model: Simple_residual, data_train: CustomDataset, batch_size = 2, max_epoch = 10, data_test = None):
...
if __name__ == '__main__':
    ...
    for fold in list(folds_index_data_AmbrosM.keys()):
        ...
        'lr': 1e-3,
        'wd': 1e-7}
        model = Simple_residual(hparam=hparam)
    ...
    df_to_submit.to_csv('results/residual_50.csv')

# !kaggle competitions submit -c open-problems-single-cell-perturbations -f results/residual_50.csv -m 'residual model' 
